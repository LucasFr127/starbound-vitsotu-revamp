...
This document acknowledges and provides credits for the original author, contributors, and creators of the assets used in the **Variety is the Spice of the Universe Mod Revamp** project.

## Original Mod

- **Variety is the Spice of the Universe**
    - Creator: [Dracyoshi](https://community.playstarbound.com/members/dracyoshi.505/)
    - Source: <https://community.playstarbound.com/resources/variety-is-the-spice-of-the-universe.199/>
...
These assets are free to use and have been attributed as follows:

1. **Post-apocalyptic background**
    - Creator: [PashaSmith](https://pashasmith.itch.io/)
    - Source: <https://pashasmith.itch.io/post-apocalyptic-background>
    - License: Custom License
        ...
        - You may not distribute or sell these assets (even if modified) and may not claim the asset as your own.

2. **Sprout**
    - Creator: [Eddie's Workshop](https://eddies-workshop.itch.io/)
    - Source: <https://eddies-workshop.itch.io/sprout>
    - License: Custom License
        - This package can be used freely and commercially.
        - Credits are not required but appreciated.

### Paid Assets

These assets have been used under a paid license:

1. **Platformer Fantasy SET6**
    - Creator: [Szadi art.](https://szadiart.itch.io/)
    - Source: <https://szadiart.itch.io/platformer-fantasy-set6>
    - License: Custom License
        - Artwork is in the public domain and free to use, for personal or commercial purposes.
        - Credit is not required, but appreciated.
        - The asset can be modified, but cannot be sold as an asset pack.
